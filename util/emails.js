...
const sendEmail=(send_to,subject,html_content)=>{
    let option={
...
const resetTemplate=()=>{
    ...
    <div align="center" class="alignment" style="line-height:10px"><a href="www.example.com" style="outline:none" tabindex="-1" target="_blank"><img alt="Your logo." src="images/5f4fa970-2c78-4218-9e89-9953d812ddb4.png" style="display: block; height: auto; border: 0; width: 160px; max-width: 100%;" title="Your logo." width="160"/></a></div>
    </td>
    </tr>
    </table>
    </td>
    ...
    <tr>
    <td class="pad" style="width:100%;padding-right:0px;padding-left:0px;">
    <div align="center" class="alignment" style="line-height:10px"><a href="www.example.com" style="outline:none" tabindex="-1" target="_blank"><img alt="Image of lock & key." class="big" src="images/___passwordreset.gif" style="display: block; height: auto; border: 0; width: 640px; max-width: 100%;" title="Image of lock & key." width="640"/></a></div>
    </td>
    </tr>
    </table>
    ...
    <tr>
    <td class="pad" style="width:100%;padding-right:0px;padding-left:0px;">
    <div align="center" class="alignment" style="line-height:10px"><a href="www.example.com" style="outline:none" tabindex="-1" target="_blank"><img alt="Your logo. " class="big" src="images/aa73bcbb-1ce0-453a-8b6f-4f9e10336b9c.png" style="display: block; height: auto; border: 0; width: 416px; max-width: 100%;" title="Your logo. " width="416"/></a></div>
    </td>
    </tr>
    </table>
